# CÓDIGO COMPLETO — assets/css/styles.css — V2.0.8
...
/* ==========================================================================
   Hotfix 2.0.7 — Drawer, checkbox e estabilidade visual
   Escopo visual: CSS, drawer/sidebar, checkbox/radio, botões e responsividade.
   ========================================================================== */
...
body.is-authenticated .content img,
body.is-authenticated .content video,
body.is-authenticated .content canvas,
body.is-authenticated .content svg {
  max-width: 100%;
  height: auto;
}

body.is-authenticated .content img:not(.brand-logo-small) {
  max-height: 260px;
  object-fit: contain;
}

/* Inputs booleanos não podem herdar o width/min-height global de input. */
input[type="checkbox"],
input[type="radio"] {
  width: 18px;
  height: 18px;
...
.switch-cell span,
.module-permission span,
.permission-row span {
  min-width: 0;
}

/* Botões: altura previsível e sem expansão vertical acidental. */
button,
.btn,
.primary-action,
.secondary-action,
...
@media (min-width: 841px) {
  ...
  .main-grid.expanded .sidebar,
  body.is-authenticated .main-grid.expanded .sidebar {
    width: 246px;
  }
  ...
  body.is-authenticated .main-grid:not(.expanded) .nav-head span:not(.material-symbols-rounded),
  body.is-authenticated .main-grid:not(.expanded) .nav-sub,
  body.is-authenticated .main-grid:not(.expanded) .nav-item span:not(.material-symbols-rounded) {
    display: none !important;
  }

  .main-grid .nav-head .material-symbols-rounded,
  .main-grid .nav-item .material-symbols-rounded,
  body.is-authenticated .main-grid .nav-head .material-symbols-rounded,
  body.is-authenticated .main-grid .nav-item .material-symbols-rounded {
  ...
  body.is-authenticated .main-grid:not(.expanded) .nav-head,
  body.is-authenticated .main-grid:not(.expanded) .nav-item {
    justify-content: center;
    padding-left: 0;
    padding-right: 0;
  }

  .main-grid:not(.expanded) .nav-group,
  body.is-authenticated .main-grid:not(.expanded) .nav-group {
    padding-left: 0;
    padding-right: 0;
  }

  .main-grid.expanded .nav-head span:not(.material-symbols-rounded),
  .main-grid.expanded .nav-sub,
  .main-grid.expanded .nav-item span:not(.material-symbols-rounded),
  body.is-authenticated .main-grid.expanded .nav-head span:not(.material-symbols-rounded),
  body.is-authenticated .main-grid.expanded .nav-sub,
  body.is-authenticated .main-grid.expanded .nav-item span:not(.material-symbols-rounded) {
    display: initial;
  }
  ...
  body.is-authenticated .main-grid.expanded .nav-head,
  body.is-authenticated .main-grid.expanded .nav-item {
    justify-content: flex-start;
  }
}
...
/* ========================================================================== 
   Hotfix 2.0.8 — Navegação lateral, mapa de menu e layout Checklist
   Escopo: somente CSS/layout visual. Backend/API/schema preservados.
   ========================================================================== */
